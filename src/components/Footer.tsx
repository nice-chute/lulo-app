...
export const Footer: FC = () => {
  return (
    <div className="flex-none px-0 pt-4">
      <footer className="items-center p-4 footer bg-black text-neutral-content text-color-green">
        ...
        <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end mr-4">
          <div className=" justify-center items-center gap-x-1 hidden md:flex ">
            <p className="text-color-green text-base font-light cursor-default ">
              Made with
            </p>
            <a
              rel="noreferrer"
              ...
              target="_blank"
              className="text-color-green text-base font-bold hover:text-primary-dark transition-all duration-200"
            >
              Solana
            </a>
          </div>
